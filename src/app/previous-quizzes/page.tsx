    ...
    questions: [
      {
        ...
        type: "open",
        answer:
          "A broad term related to the end-user's interaction with a product.",
      ...
      },
      {
        ...
        options: [
          ...
          {
            text: "Company's internal process",
            is_correct: false,
            is_selected: true,
          },
        ],
              ...
              <div className="flex items-center">
                <p>
                  ...
                  <span className="bg-blue-500 text-white rounded-md px-2 py-1">
                    {selectedQuiz.score.current}/{selectedQuiz.score.total}
                  </span>
                </p>
              </div>
            </div>
